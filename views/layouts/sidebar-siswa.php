            ...
            <div class="sidebar-logo">
                <div class="logo-header" data-background-color="dark">
                    <a href="<?= Url::to(['dashboard/index']) ?>" class="logo">
                        <img src="<?= Yii::getAlias('@web') ?>/assets/img/logo5.png" alt="Logo"
            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::to(['siswa/index']) ?>"><i class="bi bi-house"></i>
                                <p>Dashboard</p>
                            </a>
                        </li>
                        <li class="nav-section">
                            <span class="sidebar-mini-icon"><i class="bi bi-three-dots"></i></span>
                            <h4 class="text-section">Pembelajaran</h4>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="nilaiMenu">
                                <ul class="nav flex-column ms-3">
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?= Url::to(['nilai-harian-siswa/index']) ?>">Nilai
                                            Harian</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?= Url::to(['nilai-uts-siswa/index']) ?>">UTS</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?= Url::to(['nilai-uas-siswa/index']) ?>">UAS</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?= Url::to(['nilai-akhir-siswa/index']) ?>">Nilai
                                            Akhir</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="nav-item">
                            <a href="<?= Url::to(['chat/index']) ?>"><i class="bi bi-envelope"></i>
                                <p>Pesan</p>
                            </a>
                        </li>
                        <!-- ✅ Profil Saya (muncul di HP, hilang di PC) -->
                ...
                <nav class="navbar navbar-header navbar-header-transparent navbar-expand-lg border-bottom">
                    <div class="container-fluid">
                        ...
                        <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                            <li class="nav-item topbar-user dropdown hidden-caret d-none d-lg-block">
